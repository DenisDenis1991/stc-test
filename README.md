Телефонная книга React со следующей функциональностью
...
2. Просмотр всей информации о контакте при клике на кнопку редактировать

3. Механизм сортировки контактов по алфавиту. 
Сортировка выполняется по имени.
...
7. Загрузка и обрезка в рамку фото контакта.
